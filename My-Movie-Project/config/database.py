...
sqlite_file_name = '../database.sqlite' #variable para almacenenar el nombre de la base de datos, ../ ==> para que cree la base de en una carpeta anterior y no en la actual
